...
class Circle implements IShape {
  ...
  public boolean equals(Object other) {
    ...
    return (this.color.equals(that.color) && this.radius == that.radius && this.center.equals(that.center));
  }
}
...
class Square implements IShape {
  ...
  public boolean equals(Object other) {
    ...
    return this.color.equals(that.color) && this.nw.equals(that.nw) && this.size == that.size;
  }
}
...
class CartPt {
  ...
  public boolean equals(Object other) {
    if (!(other instanceof CartPt)) { return false; }
    CartPt that = (CartPt) other;
